...
pg.display.set_caption('Active Memory')

# Inicializando fonte
pg.font.init()
# Escolhendo uma fonte e tamanho
fonte = pg.font.Font(os.path.join("assets", "fonts", 'Vollkorn-SemiBold.ttf'), 40, bold=True)
...
def Tabuleiro_Hover(window, mouse_position_x, mouse_position_y):
    ...
    image_rect = bg.get_rect(center=(1000/2, 700/2))
